<template>
    <div class="essay-show" style="display: flex; justify-content: center; align-items: center;">
        <div class="show-container" style="box-shadow: 0 4px 8px rgba(0, 0, 0, 0.1);margin-top: 7rem;
    ...
    border: 0.5px rgba(0, 0, 0, 0.1) solid;">
        ...
        line-height: 20px;font-size: larger;font-weight: bolder;">{{ essayInfo.title }}</h1>
            <div class="info"
                style="display: flex;width: 100%;height: 40px;margin-top: 10px;justify-content: space-between;">
                ...
                <button class="btn"
                    style="background-color: #67c23a;border-radius: 5px;margin-top: 5px;color: aliceblue;"
                    @click="update(essayInfo.id)">编辑</button>
            </div>
